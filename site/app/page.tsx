...
export default function Home() {
 ...
 return <>
  ...
  <div className="page-layout">
   ...
   <main>
    <section className="panel about-panel" id="about"><div className="section-heading"><h2>{t.about}</h2><span className="section-number">01</span></div><p>{t.intro}</p><p>{t.research}</p><div className="news-block"><h3><span className="news-dot"/>{t.news}</h3><div className="news-row"><time>2026.09</time><p>{t.update}</p></div></div></section>
    <section className="panel" id="publications"><div className="section-heading"><h2>{t.publications}</h2><span className="section-number">02</span></div>
     <article className="paper featured-paper"><div className="paper-meta"><span className="venue">Findings of EMNLP 2026</span><span className="author-badge">{t.first}</span></div><h3><a href="https://arxiv.org/abs/2609.07362" target="_blank" rel="noreferrer">BlueprintAgent: Constraint-Triggered Targeted Revisits for Simulation-Ready Generation from Scanned Structural Blueprints <ArrowUpRight size={18}/></a></h3><p className="authors"><strong>Zhouyuan Xu</strong>, Chen Yang, Linhao Wang, Jiansheng Fan, Chen Wang</p><p className="paper-description">{t.blueprint}</p><div className="paper-bottom"><div className="tags"><span>Multimodal agents</span><span>Structural blueprints</span></div><div className="paper-links"><a className="text-link" href="https://arxiv.org/abs/2609.07362" target="_blank" rel="noreferrer">arXiv<ArrowUpRight size={15}/></a><a className="text-link" href="https://arxiv.org/pdf/2609.07362" target="_blank" rel="noreferrer">PDF<ArrowUpRight size={15}/></a><a className="text-link" href="https://openreview.net/forum?id=RMEDfZygsq" target="_blank" rel="noreferrer">OpenReview<ArrowUpRight size={15}/></a></div></div></article>
