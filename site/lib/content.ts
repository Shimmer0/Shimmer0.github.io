...
export const content = {
 en: {
  ...
  role:'Undergraduate Researcher',department:'Department of Civil Engineering',school:'Tsinghua University',location:'Beijing, China',interestTitle:'RESEARCH INTERESTS',interests:['Multimodal agents','AI for structural engineering','Physical reasoning'],
  about:'About me',intro:'I am a senior undergraduate in Civil Engineering at Tsinghua University, advised by Prof. Jiansheng Fan. I have been working on intelligent structural design with the group since fall 2024.',research:'My research connects multimodal agents with structural engineering. I focus on constraint-guided reasoning, automated interpretation of engineering drawings, and the generation, analysis, and optimization of structural designs. I am also interested in physical reasoning and embodied intelligence.',
  news:'News',update:'My first-author paper BlueprintAgent has been accepted to Findings of EMNLP 2026.',publications:'Selected publications',first:'First author',accepted:'Accepted',coauthor:'Co-author',ssi:'SSI-Bench evaluates structure-centric spatial reasoning in constraint-governed 3D spaces. My contribution focused on benchmark data annotation.',preprint:'Preprint',blueprint:'An agent that uses engineering constraints to detect conflicts and revisit local drawing evidence, turning scanned structural blueprints into simulation-ready frame models.',physmind:'A training-free framework that turns video into reusable executable worlds for physical prediction and counterfactual reasoning.',projectPage:'Project page',projects:'Projects & experience',
  projectItems:[
  ...
  ],education:'Education',degree:'B.Eng. candidate · Civil Engineering',educationDate:'Aug 2023–Present',advisor:'Research advisor: Prof. Jiansheng Fan',updated:'Last updated September 2026'
 },
 zh: {
  skip:'跳至正文',navigation:'主导航',nav:['关于','论文','项目','荣誉','教育'],light:'切换浅色模式',dark:'切换深色模式',
  role:'本科四年级',department:'土木工程系',school:'清华大学',location:'中国 · 北京',interestTitle:'研究兴趣',interests:['多模态智能体','AI × 结构工程','物理推理'],
  about:'关于我',intro:'我是清华大学土木工程系 2023 级本科生许洲沅，导师为樊健生教授。自 2024 年秋季起，我在课题组开展智能结构设计相关研究。',research:'我的研究围绕多模态智能体与结构工程的交叉展开，关注工程约束引导的推理、工程图纸的自动理解，以及结构方案的生成、分析与优化。同时，我也关注物理推理与具身智能。',
  news:'近期动态',update:'第一作者论文 BlueprintAgent 被 Findings of EMNLP 2026 接收。',publications:'代表论文',first:'第一作者',accepted:'已接收',coauthor:'共同作者',ssi:'SSI-Bench 面向受工程约束的真实三维结构，评测视觉语言模型的结构中心空间推理能力。本人参与研究，负责 benchmark 数据标注。',preprint:'预印本',blueprint:'将工程约束转化为可调用的检查工具，定位冲突并触发对局部图纸证据的定向回访，从扫描结构图纸中生成面向力学仿真的框架模型。',physmind:'从视频构建可复用、可执行的世界表示，在无需额外训练的条件下，支持物理预测与反事实推理。',projectPage:'项目主页',projects:'科研项目与实践',
  projectItems:[
  ...
  ],education:'教育经历',degree:'土木工程 · 本科在读',educationDate:'2023.08–至今',advisor:'科研导师：樊健生教授',updated:'更新于 2026 年 9 月'
 }
};
